...
DIST_SUBDIRS = contrib m4 src . po doc
am__DIST_COMMON = $(srcdir)/MHD_config.h.in $(srcdir)/Makefile.in \
	$(srcdir)/libmicrohttpd.pc.in $(top_srcdir)/build-aux/compile \
...
ACLOCAL = ${SHELL} '/home/hossein/workspace/libmicrohttpd-0.9.77/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_ASAN_OPTIONS = 
...
AR = ar
AS = as
AUTOCONF = ${SHELL} '/home/hossein/workspace/libmicrohttpd-0.9.77/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/home/hossein/workspace/libmicrohttpd-0.9.77/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/home/hossein/workspace/libmicrohttpd-0.9.77/build-aux/missing' automake-1.16
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} '/home/hossein/workspace/libmicrohttpd-0.9.77/build-aux/missing' makeinfo
MANIFEST_TOOL = :
MHD_LIBDEPS = -lpthread 
MHD_LIBDEPS_PKGCFG = -lgnutls -lpthread 
MHD_LIB_CFLAGS =  -pthread
MHD_LIB_CPPFLAGS = 
MHD_LIB_LDFLAGS =  -export-dynamic -no-undefined
MHD_PLUGIN_INSTALL_PREFIX = /usr/local/lib/libmicrohttpd
MHD_REQ_PRIVATE = 
...
PACKAGE_STRING = GNU Libmicrohttpd 0.9.77
...
_libcurl_config = 
abs_builddir = /home/hossein/workspace/libmicrohttpd-0.9.77
abs_srcdir = /home/hossein/workspace/libmicrohttpd-0.9.77
abs_top_builddir = /home/hossein/workspace/libmicrohttpd-0.9.77
abs_top_srcdir = /home/hossein/workspace/libmicrohttpd-0.9.77
ac_configure_args = 
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/hossein/workspace/libmicrohttpd-0.9.77/build-aux/install-sh
...
SUBDIRS = contrib m4 src . $(am__append_1) $(am__append_2)
